...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_setTintMode:(Landroid/graphics/PorterDuff$Mode;)V:GetSetTintMode_Landroid_graphics_PorterDuff_Mode_Handler:AndroidX.Core.Graphics.Drawable.ITintAwareDrawableInvoker, Xamarin.AndroidX.Core\n" +
			"";
